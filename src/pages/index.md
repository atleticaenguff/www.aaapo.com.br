...
extras:
  ...
  subtitle: Venha conferir tudo que preparamos para você!
  button: Saiba mais
  block1:
    undertitle: Fotos
    undersubtitle: There's something about parenthood.
  block2:
    undertitle: Vídeos
    undersubtitle: There's something about parenthood.
  block3:
...
store:
  ...
  subtitle: Venha conferir tudo que preparamos para você!
  button1: Acessar a loja
  button2: Comprar ingressos
---
